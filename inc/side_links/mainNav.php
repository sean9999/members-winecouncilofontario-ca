...
*/
	...
	if (in_array($UserLevel, $UserLevels)) {
		/*
		if($S['WineryID'] == 302) {
			echo '<li id="survey"><a href="/survey.php">Preview the Winery Sustainability Survey</a></li>';
		} else {
			echo '<li id="survey"><a href="/survey_closed.php">Winery Sustainability Survey.</a></li>';
		}
		*/
		echo '<li id="survey"><a href="/survey.php">2015 Winery Sustainability Survey</a></li>';
	}
