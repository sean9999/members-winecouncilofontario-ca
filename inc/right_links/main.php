...
//	$most_recent_chunks = getMostRecentChunks(5);
	...
	?>
	<div class="extrand hide">
	<h2><a href="javascript:animatedcollapse.toggle('my_route')">Member Contact List</a></h2>
		<div id="my_route">
			<ul>
				<li><a href="/members-listing.php" target="_blank">View Full Member Contact List</a></li>
			</ul>
		</div>
	</div>
	<?php
