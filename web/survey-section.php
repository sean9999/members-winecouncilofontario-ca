...
$SectionTable = good_query_table("SELECT SectionID, SectionNumber FROM SurveySections");

foreach($SectionTable as $SectionRow)
{
	echo '<a href="survey-section.php?SectionID='. $SectionRow['SectionID'] .'" title="Go to Survey Section ' . $SectionRow['SectionNumber'] . '" class="active">'. $SectionRow['SectionNumber']  .'</a>&rarr;';
}
...
<a href="/survey-submit.php" title="Go to the Submission Page">Submit</a>
