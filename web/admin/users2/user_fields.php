...
<tr>
	...
	<td>
		<Select name="WineryID">
				<option value="99999"<?php if($user['WineryID'] == 99999) echo 'selected="selected"';?>>* Trade / Non-Winery Organization</option>
				<option value="88888"<?php if($user['WineryID'] == 88888) echo 'selected="selected"';?>>* Winery is not listed</option>		
			<?php
...
<tr>
	...
	<td>
		<select name="UserLevel" width="50">
			...
			<option value="Non-Member" <?php if($user['UserLevel'] == 'Non-Member') echo 'selected="selected"';?>>Non-Member</option>
			<option value="Trade" <?php if($user['UserLevel'] == 'Trade') echo 'selected="selected"';?>>Trade</option>			
		</select>
	</td>
</tr>
<tr>
...
<tr>
	<td>Email</td>
	<td><input type="text" name="Company" value="<?= $user['Company'] ?>" size="50" /></td>
</tr>
<tr>
	<td>Notes</td>
