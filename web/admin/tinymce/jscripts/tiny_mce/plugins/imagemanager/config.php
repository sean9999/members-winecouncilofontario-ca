<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] . '/content/' ; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,pdf,xls,xlsx";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,pdf,xls,xlsx";
	...
	$mcImageManagerConfig['upload.max_width'] = "680"; // Only if force_width_height is true
	$mcImageManagerConfig['upload.max_height'] = "450"; // Only if force_width_height is true
	...
	$mcImageManagerConfig['authenticator.login_page'] = "just_go.php";
