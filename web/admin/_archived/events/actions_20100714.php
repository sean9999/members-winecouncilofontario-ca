...
switch ($action) {
	...
	$ins_SQL			= <<<BLOCK
	INSERT INTO Events (event_day,event_month,event_year,event_time,event_title,event_desc,event_banner,event_date,event_date_end,event_time_end,event_region_ids,event_attraction_tags,info_hours,info_location,info_phone,info_email,info_website,is_active,is_priority)
	VALUES ($E[event_day],$E[event_month],$E[event_year],'$P[event_time]','$P[event_title]','$P[event_desc]','$P[event_banner]','$P[event_date]','$P[event_date_end]','$P[event_time_end]','$E[eri]','$E[eat]','$P[info_hours]','$P[info_location]','$P[info_phone]','$P[info_email]','$E[web]',$E[is_active],$E[is_priority])
BLOCK;
